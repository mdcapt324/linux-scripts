...
(set-face-attribute 'fixed-pitch nil :font "Fira Code Retina" :height 90)
...
;; theme: The first time you load your configuration on a new machine, you'll
...
(defun efs/org-font-setup ()
  ...
  ;; Ensure tha anything that should be fixed-pitch in Org files appears that way
...
(use-package org
  ...
  (setq org-capture-templates
    `(("t" "Tasks / Projects")
      ("tt" "Task" entry (file+olp "~/.emacs.d/org-files/Tasks.org" "Inbox")
       "* TODO %?\n  %U\n  %a\n  %i" :empty-lines 1)
      ("ta" "Task" entry (file+olp "~/.emacs.d/org-files/Tasks.org" "Active")
           "* TODO %?\n  %U\n  %a\n  %i" :empty-lines 1)
  ...
  (define-key global-map (kbd "C-c a")
    (lambda () (interactive) (org-capture nil "ta")))
...
This will auto tangle the Emacs.org file into the init file listed at the top whenever the Emacs.org file is saved.
